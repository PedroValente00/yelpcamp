...
const seedDB = async (num) => {
  ...
  for (let i = 0; i < num; i++) {
    ...
    const entry = new Campground({
      author: "66bde30697b0225eb32413fa",
      ...
      reviews:
        [
          await new Review({
            body: "random review", author: "66bde30697b0225eb32413fa",
            rating: Math.floor(Math.random() * 5) + 1
          }).save(),
          await new Review({
            body: "another random review", author: "66bde30697b0225eb32413fa",
            rating: Math.floor(Math.random() * 5) + 1
          }).save()
        ],
      geometry: {
...
seedDB(0).then(() => mongoose.connection.close())